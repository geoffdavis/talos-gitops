...
class TestOAuth2RedirectFixScript:
    ...
    def test_python_script_contains_required_classes(self):
        ...
        for method_name in required_methods:
            assert method_name in fixer_methods, \
    ...
    def test_fix_all_oauth2_redirects_integration(self):
        ...
        with patch.object(fixer, '_make_api_request') as mock_api:
            ...
            mock_api.side_effect = [
                ...
                (200, {'results': list(self.sample_applications.values())}),  # get applications
                (200, {'results': []}),  # get proxy providers
                (200, {'results': list(self.sample_providers.values())}),  # get oauth2 providers
...
class TestOAuth2RedirectFixJobConfiguration:
    ...
    def test_job_environment_variables(self):
        ...
        config_container = next(
            ...
            if c['name'] == 'fix-oauth2-redirects'
        )
        
        env_vars = {
            env['name']: env for env in config_container.get('env', [])
        }
        ...
        assert env_vars['AUTHENTIK_EXTERNAL_URL']['value'] == 'https://authentik.k8s.home.geoffdavis.com'
